...
unsigned test_c (unsigned i0, unsigned i1,
...
void write8 (unsigned short address, unsigned char data)
{
  e6809_write8(address, data);
}

unsigned read16 (unsigned short address)
{
# if 1
...
void write16 (unsigned short address, unsigned data)
{
